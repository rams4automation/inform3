...
import com.Synovus.accelerators.Configurations;

//import com.poc.testengine.Configurations;
...
public class HtmlReportSupport {
	...
	public static configurator configProps = new configurator("config.properties");
	...
	public static void createHtmlSummaryReport(String browser,
		...
		try {
			...
			writer.write("<title>D3 - Automation Execution Results Summary</title>");
			...
			writer.write("D3 -  Automation Execution Result Summary ");
			writer.write("</th> ");
			writer.write("</tr> ");
			...
			writer.write("<th>	HTML Report	</th> ");
			writer.write("</tr> ");
			...
			while (iterator1.hasNext()) {
				...
				if(!(time.equals("0"))){
					...
					writer.write("<td class='justified'>"
							+ Configurations.testDescription.get(key[1]) + "</td>");                  
                 
					writer.write("<td>" + executionTime.get(key[1])
							+ " Seconds</td>");
					if (Configurations.testResults.get(key[1]).equals("PASS"))
